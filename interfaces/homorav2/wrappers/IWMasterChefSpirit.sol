...
import '../../spiritswap/IMasterChefSpirit.sol';
import '../IERC20Wrapper.sol';
import '../IGovernable.sol';

interface IWMasterChefSpirit is IERC1155, IERC20Wrapper, IGovernable {
  /// @dev Return Spiritswap masterChef
  function chef() external view returns (IMasterChefSpirit);

  /// @dev Return SPIRIT token
