...
interface ISpookySwapSpellV2 {
  ...
  /// @dev Add liquidity to SpookySwap pool, with staking to masterChef
  ...
  /// @dev Remove liquidity from SpookySwap pool, from masterChef staking
  /// @param tokenA Token A for the pair
  /// @param tokenB Token B for the pair
